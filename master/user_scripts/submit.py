...
while(True):
	try:
		...
		messageutils.make_and_send_message(msg_type = "JOB SUBMIT", content = "submit this job", file_path = args.JobPath, to = network_params.SERVER_IP, port = network_params.SERVER_PORT)
